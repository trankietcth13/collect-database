                                    ...
                                    foreach (string _listModels in AllModels)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //{
                                                ...
                                                int colofTagTd = 4;
                                                int count = 0;
                                                foreach (var item_TagTd in AlltagTd)
                                                {
                                                    count++;
                                                    if(count >= AlltagTd.Count)
                                                    {
                                                        break;
                                                    }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            MySheet.Cells[row, colofTagTd].Value = AlltagTd[count];//get engine
                                                            package.Save();
                                                            colofTagTd++;
                                                            continue;
                                                        }
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                MySheet.Cells[row, colofTagTd].Value = AlltagTd[count + 1];//get BCI
                                                                colofTagTd++;
                                                                MySheet.Cells[row, colofTagTd].Value = AlltagTd[count + 2];//get CCA
                                                                colofTagTd = 4;
                                                                package.Save();
                                                                row++;
                                                                continue;
